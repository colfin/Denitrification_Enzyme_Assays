...
sharedfile = "../data/mothur/Ag_HC_LD_Oct25Mothur.opti_mcc.shared"

rarefaction = "../data/mothur/Ag_HC_LD_Oct25Mothur.opti_mcc.groups.rarefaction"

taxfile = "../data/mothur/Ag_HC_LD_Oct25Mothur.opti_mcc.0.03.cons.taxonomy"

asv_shared = "../data/mothur/ASV/Ag_HC_LD_Oct25Mothur.asv.shared"
asv_taxfile = "../data/mothur/ASV/Ag_HC_LD_Oct25Mothur.asv.0.03.cons.taxonomy"
...
asv <- read_tsv(asv_shared)


s<- sum(colSums(otu)) #2250
s
...
#otu<- colSums(t(otu.))
otu[which.min(colSums(t(otu)))]
otu[which.max(colSums(t(otu)))]
...
min.N <- min(rowSums(otu))
min.N

# new df wich drops the sample with only 2 otu hits:
otu.2 <- otu[rownames(otu) != "AGLD004bc093", ]

# new min sample number
min.N_2 <- min(rowSums(otu.2))
min.N_2
...
otu.3 <- vegan::rrarefy(otu, min.N_2)
```
