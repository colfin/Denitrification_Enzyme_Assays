...
denit_soil_all_meta %>%
  ...
  # QQ plots:
ggqqplot(denit_soil_all_meta, "log_denit")

ggqqplot(denit_soil_all_meta, "log_EC")

ggqqplot(denit_soil_all_meta, "log_moisture")
```
...
plot.denit.1a <- ggplot(denit_soil_all_meta, aes(x=Field_or_Buffer, y=Denitrification_rate)) +
  ...
  geom_text(data = denit_letters.1a, aes(x = Field_or_Buffer, y = max(denit_soil_all_meta$Denitrification_rate) + 5000, label = Letters), size = 8)
