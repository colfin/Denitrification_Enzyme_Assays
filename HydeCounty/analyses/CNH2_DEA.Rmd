...
setwd("~/GitHub/CNH2/analyses")

# Use to set root directory for knitr
knitr::opts_knit$set(root.dir="~/GitHub/CNH2/analyses")
```
...
denit_rates <- read.csv("~/GitHub/CNH2/data/denit_rates_HydeCo_20221208.csv")

# Read in denitrification rate calculation with CORRECTED rates for morning samples:
denit_CORRECTED <- read.csv("~/GitHub/CNH2/data/CORRECTED_denit_rates_HydeCo_20221208.csv")
```
